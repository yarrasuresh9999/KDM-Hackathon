    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            try
            {
                ...
                con.Open();
                string strquery = "select s.SearchString,s.SearchTime from dbo.Users as u inner join Searches as s on u.UserId=s.UserId where s.UserId='" + user.UserID + "' order by s.SearchTime";
