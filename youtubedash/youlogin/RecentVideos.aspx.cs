    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            try
            {
                ...
                con.Open();
                string strquery = "select v.Thumbnail,v.VideoID,v.Description,v.ViewedTime from dbo.Users as u inner join Videos as v on u.UserId=v.UserId where v.UserId='" + user.UserID + "' order by v.ViewedTime";
