<%@ Page Language="C#" MasterPageFile="~/youlogin/PopUpMasterPage.master" AutoEventWireup="true" CodeFile="register.aspx.cs" Inherits="youlogin_register" %>
...
<script src="js/jquery.timepicker.js"></script> 
   ...
   <div class="row">
        <form class="form-horizontal" style="margin-top:15px;" id="form" runat="server">
            <h3 style="color:#317E9A">Register</h3>
            <hr>
            ...
            <div class="form-group">
             ...
             <div class="form-group">
              <div class="input-group col-xs-10 col-xs-offset-1 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2 col-lg-6 col-lg-offset-3">
                ...
                <input type="password" class="form-control disable" id="txtPassword" placeholder="Password" runat="server" required />
              </div>
            </div>
             <div class="form-group">
              <div class="input-group col-xs-10 col-xs-offset-1 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2 col-lg-6 col-lg-offset-3">
              ...
              <div class="input-group col-xs-offset-1 col-sm-offset-1 col-sm-11 col-md-10 col-md-offset-0">
                 <div class="pull_right">&nbsp; &nbsp;</div><asp:Button ID="register" class="btn btn-primary" data-loading-text="Registering..." autocomplete="off" runat="server" Text=" &nbsp;&nbsp;&nbsp;&nbsp;Register&nbsp;&nbsp;&nbsp;&nbsp; " onclick="Register_Click"></asp:Button>
              </div>
            </div>
               </form>
      </div>
